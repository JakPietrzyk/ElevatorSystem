...
class ElevatorControllerTest {
    ...
    void Pickup_To_Other_Directions_Should_Both_Elevators_Not_Idle_Finishes_On_5_And_2_Floors()
    {
        ...
        elevatorControllerWithTwoElevators.step();
        elevatorControllerWithTwoElevators.step();
        assertEquals(5, elevatorControllerWithTwoElevators.status().getFirst().getCurrentFloor());
        assertEquals(2, elevatorControllerWithTwoElevators.status().getLast().getCurrentFloor());
    }

    @Test
    void Elevators_On_Same_Floor_Gets_Pickup_To_Others_Directions_Should_Each_Elevator_Get_Request()
    {
        int firstElevatorId = elevatorControllerWithTwoElevators.status().getFirst().getId();
        int secondElevatorId = elevatorControllerWithTwoElevators.status().getLast().getId();
        ...
        assertEquals(ElevatorDirection.Up, elevatorControllerWithTwoElevators.status().getFirst().getDirection());
        assertEquals(ElevatorDirection.Down, elevatorControllerWithTwoElevators.status().getLast().getDirection());
        assertEquals(3, elevatorControllerWithTwoElevators.status().getFirst().getDestinationFloor());
        assertEquals(0, elevatorControllerWithTwoElevators.status().getLast().getDestinationFloor());
    }
    ...
    void Elevators_On_Same_Floor_Pickup_To_Up_Direction_Should_One_Elevator_Get_Requests()
    {
        ...
        elevatorControllerWithTwoElevators.pickup(3, ElevatorDirection.Up);
        assertEquals(ElevatorDirection.Up, elevatorControllerWithTwoElevators.status().getFirst().getDirection());
        assertEquals(ElevatorDirection.Idle, elevatorControllerWithTwoElevators.status().getLast().getDirection());
        assertEquals(3, elevatorControllerWithTwoElevators.status().getFirst().getDestinationFloor());
        elevatorControllerWithTwoElevators.step();
        elevatorControllerWithTwoElevators.step();
        String input = "n\n";
        System.setIn(new ByteArrayInputStream(input.getBytes()));
        elevatorControllerWithTwoElevators.step();
        assertEquals(5, elevatorControllerWithTwoElevators.status().getFirst().getDestinationFloor());
    }
    ...
    void Elevators_On_Same_Floor_Pickup_To_Down_Direction_Should_One_Elevator_Get_Requests()
    {
        ...
        assertEquals(ElevatorDirection.Down, elevatorControllerWithTwoElevators.status().getFirst().getDirection());
        assertEquals(ElevatorDirection.Idle, elevatorControllerWithTwoElevators.status().getLast().getDirection());
        assertEquals(0, elevatorControllerWithTwoElevators.status().getFirst().getDestinationFloor());
        String input = "n\n";
        System.setIn(new ByteArrayInputStream(input.getBytes()));
        elevatorControllerWithTwoElevators.step();
        elevatorControllerWithTwoElevators.step();
        assertEquals(-1, elevatorControllerWithTwoElevators.status().getFirst().getDestinationFloor());
    }
    ...
    void Elevators_On_Same_Floor_Pickup_On_Idle_Floor_Nothing_Changes()
    {
        ...
        assertEquals(ElevatorDirection.Idle, elevatorControllerWithTwoElevators.status().getFirst().getDirection());
        assertEquals(ElevatorDirection.Idle, elevatorControllerWithTwoElevators.status().getLast().getDirection());
    }
    ...
    void Elevators_On_2_And_0_Floor_Pickup_1_4_5_Should_Both_Elevator_Get_Requests()
    {
        ...
        assertEquals(ElevatorDirection.Up, elevatorControllerWithTwoElevators.status().getFirst().getDirection());
        assertEquals(ElevatorDirection.Up, elevatorControllerWithTwoElevators.status().getLast().getDirection());
        assertEquals(4, elevatorControllerWithTwoElevators.status().getFirst().getDestinationFloor());
        assertEquals(1, elevatorControllerWithTwoElevators.status().getLast().getDestinationFloor());
        String input = "n\n";
        System.setIn(new ByteArrayInputStream(input.getBytes()));
        elevatorControllerWithTwoElevators.step();
        System.setIn(new ByteArrayInputStream(input.getBytes()));
...
//        elevatorControllerWithTwoElevators.step();
        assertEquals(ElevatorDirection.Up, elevatorControllerWithTwoElevators.status().getLast().getDirection());
        assertEquals(4, elevatorControllerWithTwoElevators.status().getLast().getDestinationFloor());
    ...
    {
        int firstElevatorId = elevatorControllerWithSingleElevator.status().getFirst().getId();
        ...
        assertEquals(ElevatorDirection.Up, elevatorControllerWithSingleElevator.status().getFirst().getDirection());
        assertEquals(3, elevatorControllerWithSingleElevator.status().getFirst().getDestinationFloor());
        String input = "n\n";
        System.setIn(new ByteArrayInputStream(input.getBytes()));
        ...
        System.setIn(new ByteArrayInputStream(input.getBytes()));
        elevatorControllerWithSingleElevator.step();
        assertEquals(5, elevatorControllerWithSingleElevator.status().getFirst().getDestinationFloor());
        System.setIn(new ByteArrayInputStream(input.getBytes()));
        elevatorControllerWithSingleElevator.step();
        System.setIn(new ByteArrayInputStream(input.getBytes()));
        elevatorControllerWithSingleElevator.step();
        assertEquals(4, elevatorControllerWithSingleElevator.status().getFirst().getDestinationFloor());
        assertEquals(ElevatorDirection.Down, elevatorControllerWithSingleElevator.status().getFirst().getDirection());
    }
}
